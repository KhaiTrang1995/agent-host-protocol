...
const STATE_STRUCTS: { name: string; omitDiscriminants?: boolean; rustName?: string }[] = [
  ...
  { name: 'ToolResultTerminalOutputContent', omitDiscriminants: true },
...
const TOOL_RESULT_CONTENT_UNION: UnionConfig = {
  ...
  variants: [
    ...
    { variantName: 'TerminalOutput', innerType: 'ToolResultTerminalOutputContent', wireValue: 'terminalOutput' },
